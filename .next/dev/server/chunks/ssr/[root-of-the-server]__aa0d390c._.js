...
const createNote = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/notes", data);
    return res.data;
};
const deleteNote = async (id)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/notes/${id}`);
    return res.data;
};
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa0d390c._.js.map