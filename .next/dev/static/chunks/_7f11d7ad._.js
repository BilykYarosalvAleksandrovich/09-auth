                    ...
                    try {
                        ...
                        if (user) {
                            ...
                            const isPrivate = PRIVATE_ROUTES.some({
                                "AuthProvider.useEffect.checkAuth.isPrivate": (route)=>pathname.startsWith(route)
                            }["AuthProvider.useEffect.checkAuth.isPrivate"]);
                            if (isPrivate) {
...
_s(AuthProvider, "BT52Ucg+BJ+iof1aebjGPdwLzZc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
